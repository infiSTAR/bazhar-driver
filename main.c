// 1/1 paste of joona70 + btbd's work
// may not be the exact good code but it'll do the same thing and it's literally using the same swapcontrol so i think so :D.
// then it got renamed to "bazharDriver"....
